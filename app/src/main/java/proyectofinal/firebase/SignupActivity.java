package proyectofinal.firebase;
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(passwordcheck)) {
                    Toast.makeText(getApplicationContext(), "Reingrese el  password!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if (password.length() < 6) {
                    Toast.makeText(getApplicationContext(), "Password demasiado corto, minimo 6 caracteres", Toast.LENGTH_SHORT).show();
                    return;
                }
